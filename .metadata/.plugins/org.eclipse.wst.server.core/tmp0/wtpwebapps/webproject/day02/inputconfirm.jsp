...
<p>9.전공<%=request.getParameter("major") %></p>
<p>10.학습과목</p>
<p>11.number:<%=request.getParameter("input8")%></p>
<p>12.range:<%=request.getParameter("input9")%></p>
<ul>
<%
...
for(int i = 0; arr != null && i < arr.length; i++){
	...
	//out은 HTML의 body를 의미하는 jps가 내장하는 객체
	//system.out은 모니터를 의미(수행되는곳의 console)
}
%>
</ul>
<p>13 date.<%=request.getParameter("input10") %></p>
<p>14 month.<%=request.getParameter("input11") %></p>
<p>15 week.<%=request.getParameter("input12") %></p>
<p>16 hidden<%=request.getParameter("input16")%></p>
<p>17 memo<%=request.getParameter("memo") %></p>
