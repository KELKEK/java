...
<script>
	...
	function f_dupCheck(){
		$.ajax({
			url:"/webproject/day01/jsp/emailCheck.jsp",
			type:"get",
...
HTML 주석 : 개발자에게 코드를 설명하기 위함함
  ...
  참고로 JSP주석이 아닌 일반 주석을 쓸 경우 주석의 정보도 같이 넘어가므로 JSP에서 주석을 쓸 일이 있으면 무조건 이 방식의 주석을 쓰자.
   --%>
...
<input class = "deco" type="submit" value="입력">
<input class = "deco" type="reset" value="초기화">
